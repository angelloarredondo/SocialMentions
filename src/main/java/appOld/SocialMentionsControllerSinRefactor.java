...
import SocialMentions.SocialMentions.infraestructure.FacebookAnalyzer;
import SocialMentions.SocialMentions.infraestructure.SocialMentionMapper;
import org.springframework.web.bind.annotation.PostMapping;
import org.springframework.web.bind.annotation.RequestBody;
import org.springframework.web.bind.annotation.RestController;

@RestController
public class SocialMentionsControllerSinRefactor {
...
// Analyze facebook post (if facebook is already low then skip this analysis)
    ...
    private static class TweeterAnalyzer {
        public static Double analyzeTweet(String message, Object tweeterUrl, String tweeterAccount) {
            return null;
        }
    }
}
